...
NAN_METHOD(getVision) {
    ...
    NanReturnValue(NanNew(json.str()));
}

void vision_init(Handle<Object> exports) {
    ...
    exports->Set(NanNew("getVision"),
                 NanNew<FunctionTemplate>(getVision)->GetFunction());

}

NODE_MODULE(vision, vision_init);
